...
public class Copa {
    ...
    private Time qatar = new Time("Catar");
    private Time senegal = new Time("Senegal");
    private Time usa = new Time("Estados Unidos");
    private Time england = new Time("Inglaterra");
    private Time wales = new Time("Gales");
    private Time iran = new Time("Irã");
    private Time mexico = new Time("México");
    private Time argentina = new Time("Argentina");
    private Time poland = new Time("Polônia");
    private Time arabia = new Time("Arabia Saudita");
    private Time australia = new Time("Austrália");
    private Time tunisia = new Time("Tunísia");
    private Time france = new Time("França");
    private Time denmark = new Time("Dinamarca");
    private Time germany = new Time("Alemanha");
    private Time japan = new Time("Japão");
    private Time spain = new Time("Espanha");
    private Time costarica = new Time("Costa Rica");
    private Time morocco = new Time("Marrocos");
    private Time croatia = new Time("Croácia");
    private Time belgium = new Time("Bélgica");
    private Time canada = new Time("Canadá");
    private Time switzerland = new Time("Suíça");
    private Time cameroon = new Time("Camarões");
    private Time brazil = new Time("Brasil");
    private Time serbia = new Time("Sérvia");
    private Time uruguay = new Time("Uruguai");
    private Time korea = new Time("Coréia");
    private Time portugal = new Time("Portugal");
    private Time ghana = new Time("Gana");
